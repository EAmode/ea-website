        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-5">
              <div class="social-share">
                <ul>
                  <li>
                    <a
                      href="https://www.youtube.com/channel/UCB5glozWeUqxAhgh3wYWasg"
                      target="_blank"
                      aria-label="youtube"
                      ><svg
                        aria-hidden="true"
            ...
            <div class="action col-sm-7">
              ...
              <ea-color-scheme-toggle selector="body.mode"></ea-color-scheme-toggle>
            </div>
          </div>
        </div>
      </div>
